...
const Contact = () => {
    return (
        <div className='mx-auto max-w-5xl space-y-2 px-4 md:px-0'>
            ...
            <div>
                <a className='text-xl font-semibold text-gray-900 dark:text-white' href='mailto:namtle98@gmail.com'>namtle98@gmail.com</a>
            </div>
        </div>
    )
}
